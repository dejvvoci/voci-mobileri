...
@Component({
  ...
  template: `
    <div class="page-header">
      <div>
        <h1 class="page-title font-display">Produkte</h1>
        <p class="page-sub">{{ products().length }} punime të regjistruara</p>
      </div>
              ...
              <tr>
                <td>
                  <div class="table-thumb">
                    <img [src]="p.images[0]?.url || placeholder"
                ...
                <td>
                  <div class="action-btns">
                    <a [routerLink]="['/admin/produkte/ndrysho', p.id]"
      ...
      <div class="modal-backdrop" (click)="deleteTarget.set(null)">
        <div class="modal" (click)="$event.stopPropagation()">
          ...
          <p style="color:var(--text-muted);font-size:14px;margin:0 0 24px">
            ...
            {{ deleteTarget()!.images.length }} imazhet nga Storage. Ky veprim nuk kthehet.
          </p>
